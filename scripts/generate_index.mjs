...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .clinic-banner { margin-top: 40px; }
  .clinic-link { display: flex; align-items: center; gap: 14px; padding: 16px 20px; background: var(--surface); border: 1px solid var(--line); border-radius: 12px; text-decoration: none; color: var(--text); transition: all 0.2s; }
  .clinic-link:hover { background: var(--accent-soft); border-color: var(--accent); transform: translateX(4px); }
  .clinic-icon { font-size: 24px; flex-shrink: 0; }
  .clinic-name { font-size: 15px; font-weight: 700; flex: 1; }
  .clinic-arrow { font-size: 16px; color: var(--accent); font-weight: 700; }
...
<div class="container">
  ...
  <div class="clinic-banner" style="margin-top:10px">
  ...
  <footer>
<p>Powered by PubMed + NVIDIA AI · <a href="https://github.com/u8901006/fitness-brain">GitHub</a></p>
  </footer>
</div>
</body>
</html>`;
